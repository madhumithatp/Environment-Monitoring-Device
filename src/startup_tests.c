...
void test_task_timer_handler()
{
    ...
    {
        perror("BIST failed. Exiting Program...");
        exit(1);
    }
...
return_status built_in_startup_tests()
{
    ...
    {
        perror("Error Reading THIGH reg \n");
        //goto RESTART_T;
    }
    ...
    {
        perror("Error in read APDS9301 Timing Register\n");
        //goto RESTART_L;
    }
 
    if(apds9301_write_reg_2byte(APDS9301_REG_TH_LOW_LOW,APDS903_TH_LOW_VAL))
    {
        perror("Error in writing APDS9301 TH Low \n");
        //goto RESTART_L;
    }
    ...
    {
        perror("Error in read APDS9301 Th LOW\n");
        //goto RESTART_L;
    }
    if(apds9301_write_reg_2byte(APDS9301_REG_TH_HIGH_LOW,APDS903_TH_HIGH_VAL))
    {
        perror("Error in writing APDS9301 TH HIGH \n");
        //goto RESTART_L;
    }
    val = apds9301_read_reg_2byte(APDS9301_REG_TH_HIGH_LOW);
     if(val != APDS903_TH_HIGH_VAL)
    {
        perror("Error in read APDS9301 Th High\n");
        //goto RESTART_L;
    }
